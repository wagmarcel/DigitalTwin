...
def request_get_successful(url, timeout):
    """
...
def request_get_failed(url, timeout):
    """
    get request failed
    """
    response = Bunch()
...
def request_get_successful_job_status(url, timeout):
    """
    get job status
    """
    response = Bunch()
...
def request_post_successful(url, json, timeout):
    """
    post request
    """
    response = Bunch()
...
def request_patch_successful(url, timeout):
    """
    send patch request
    """
    response = Bunch()
