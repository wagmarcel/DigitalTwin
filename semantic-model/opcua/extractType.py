...
parse nodeset instance and create ngsi-ld model')
    ...
    parser.add_argument('-xe', '--entity-namespace', help='Overwrite Namespace for entities (which is otherwise derived from <namespace>/entity)', required=False)
    parser.add_argument('-xc', '--context-url', help='Context URL', default="https://industryfusion.github.io/contexts/staging/opcua/v0.1/context.jsonld", required=False)
    parser.add_argument('-xp', '--entity-prefix', help='prefix in context for entities', default="uaentity", required=False)
