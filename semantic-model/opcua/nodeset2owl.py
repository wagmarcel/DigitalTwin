...
Schema/Opc.Ua.Types.xsd')
    parser.add_argument('--import-indirect-dependencies', action="store_true", default=False, help='Import not only direct dependencies but also indirect dependencies.')
...
if __name__ == '__main__':
    ...
    nodesetparser = NodesetParser(args, opcua_nodeset, opcua_inputs, versionIRI, data_schema, imported_ontologies, not args.import_indirect_dependencies)
    nodesetparser.parse()
