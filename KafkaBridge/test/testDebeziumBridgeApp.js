...
describe('Test sendUpdates', function () {
  it('Should update and delete attributes', async function () {
    const messages = [
      ...
      { key: 'id', value: '{"deleteValueKey":"deleteValueValue","deleted":true}' },
  ...
  it('Should flatten input arrays of attributes', async function () {
    const messages = [
      { key: 'id', value: '{"id":"id","type":"http://example/type"}' },
      [{ key: 'id', value: '{"deleteValueKey":"deleteValueValue","deleted":true}' }, { key: 'id', value: '{"deleteValueKey":"deleteValueValue2","deleted":true}' }],
